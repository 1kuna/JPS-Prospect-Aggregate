        ...
        if check_table_exists(engine, "prospects"):
            ...
            for col in problematic_columns:
                ...
                if exists:
                    ...
                    click.echo(
                        f"  - {col}: EXISTS (might cause duplicate column error)"
                    )
                else:
            ...
            if columns_exist and not current_rev:
                ...
                click.echo(
                    "This suggests the database was created outside of migrations."
                )
                ...
                if fix:
                    ...
                    if len(columns_exist) == len(problematic_columns):
                        ...
                        click.echo(
                            "Only some columns exist. Manual intervention required."
                        )
                else:
                    click.echo()
