...
from app.services.set_aside_standardization import StandardSetAside, SetAsideStandardizer
...
class TestSetAsideStandardization:
    ...
    def test_prompt_includes_mapping_examples(self, standardizer):
        ...
        for input_val, expected_output in test_cases:
            assert input_val in prompt, f"Example input '{input_val}' should be in prompt"
    ...
    def test_enum_completeness(self):
        ...
        for expected in expected_types:
            assert expected in actual_types, f"Expected set-aside type '{expected}' not found"
        
        # Verify no extra types
        assert len(actual_types) == len(expected_types), "Unexpected set-aside types found"
